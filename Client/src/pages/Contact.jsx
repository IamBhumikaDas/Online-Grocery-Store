...
const Contact = () => {
 ...
 const submit=()=>{
  ...
  return (
    ...
    >
    <div className='mt-5'>
     <form className=" mt-5 py-4 flex flex-col items-center text-sm text-slate-800">
            <p className="text-xs bg-primary text-white font-medium px-3 py-1 rounded-full">Contact Us</p> 
            <h1 className="text-4xl font-bold py-4 text-center">Let’s Get In Touch.</h1>
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-primary hover:underline">dbhumika@gmail.com</a>
            </p>
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <button onClick={submit} type="submit" className="flex items-center justify-center gap-1 mt-5 bg-primary hover:bg-primary-dull text-white py-2.5 w-full rounded-full transition">
                    Submit Form
