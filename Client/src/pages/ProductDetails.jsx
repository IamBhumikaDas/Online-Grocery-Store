...
{/* related products */}
            <div className="flex flex-col items-center mt-20">
                <div className="flex flex-col items-center w-max"><p className="text-3xl font-medium">Related Products</p></div>
                ...
                <button onClick={()=>{navigate('/products');scrollTo(0,0)}} className="mt-12 px-6 py-2 border border-primary text-primary rounded hover:bg-primary/10 transition block mx-auto">
                See More</button>
            </div>
        </div>
    );
